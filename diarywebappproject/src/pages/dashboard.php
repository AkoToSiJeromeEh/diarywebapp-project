        ...
        <?php 
            function getRecentEntry($category){
                ...
                if(isset($_SESSION['UserID'])){
                    ...
                    $sql = "SELECT title, entry_content FROM diary_entry WHERE category = '$category' AND EntryID='$UserID 'ORDER BY entry_date DESC LIMIT 1";
            ...
            <div
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 grid-flow-dense gap-y-5 gap-x-6">
                    <div
                        ...
                        "Paint the Town Red" by Doja Cat is an energetic and infectious pop track. Its upbeat tempo, catchy melodies, and playful lyrics exude confidence and party vibes, encouraging listeners to let loose and have a good time.
                        </p>
                    </div>
                    <div
                        ...
                        <p class="font-normal text-center small:text-start md:text-center text-sm lg:text-[1rem]">
                        "Here with Me" by David is a tender love song that conveys the joy of having a cherished partner by one's side. Its heartfelt lyrics and melodic arrangement that create an emotional, comforting ambiance, celebrating the presence of a loved one
                        </p>
                    </div>
                    <div
                        ...
                        <p class="font-normal text-center small:text-start md:text-center text-sm lg:text-[1rem]">
                        "Sparks" by Coldplay is a serene and melancholic ballad. Chris Martin's evocative vocals and delicate piano work create an intimate atmosphere. The song explores longing and nostalgia, delivering a bittersweet and reflective experience
                        </p>
                    </div>
                </div>
            </div>
